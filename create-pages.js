...
const pages = {
  'seguro-viagem-paraguai': `import Link from 'next/link'
...
`,
  ...
  'duty-free-foz-do-iguacu': `import Link from 'next/link'
...
for (const [slug, content] of Object.entries(pages)) {
  ...
  console.log(`OK - criado: app/${slug}/page.jsx`)
}

console.log('\nPronto! Agora atualize o sitemap.js para incluir as 2 novas paginas.')
